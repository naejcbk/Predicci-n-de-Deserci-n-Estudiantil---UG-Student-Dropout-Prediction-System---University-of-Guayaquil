...
## App en la Nube
[👉 Haz clic aquí para ver la aplicación funcionando en vivo]((https://yd8mg2z6wxamugr4neujjm.streamlit.app/))
...
3. **Preparación de Datos:** Limpieza y normalización de formatos.
4. **Modelado:** Implementación de **Random Forest Classifier**.
5. **Evaluación:** Alcance de un 86% de Recall (Sensibilidad).
6. **Despliegue:** Interfaz interactiva en Streamlit.
